...
# Form implementation generated from reading ui file 'PythIon/ui/maingui.ui'
#
...
class Ui_PythIon(object):
    def setupUi(self, PythIon):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("PythIon/ui/../../pythionlogo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-color: rgb(0, 0, 0);")
        ...
        self.horizontalLayout_fft = QtWidgets.QHBoxLayout(self.ffttab)
        self.horizontalLayout_fft.setObjectName("horizontalLayout_fft")
        self.fftplot = GraphicsLayoutWidget(self.ffttab)
        self.fftplot.setObjectName("fftplot")
        self.horizontalLayout_fft.addWidget(self.fftplot)
        self.tabWidget_2.addTab(self.ffttab, "")
        self.fftspectrumtab = QtWidgets.QWidget()
        self.fftspectrumtab.setObjectName("fftspectrumtab")
        self.gridLayout_fftspectrum = QtWidgets.QGridLayout(self.fftspectrumtab)
        self.gridLayout_fftspectrum.setObjectName("gridLayout_fftspectrum")
        self.fftspectrumplot = GraphicsLayoutWidget(self.fftspectrumtab)
        self.fftspectrumplot.setObjectName("fftspectrumplot")
        self.gridLayout_fftspectrum.addWidget(self.fftspectrumplot, 0, 0, 1, 1)
        self.horizontalLayout_fftspectrum = QtWidgets.QHBoxLayout()
        self.horizontalLayout_fftspectrum.setObjectName("horizontalLayout_fftspectrum")
        self.label_fftspectrumbinwidth = QtWidgets.QLabel(self.fftspectrumtab)
        self.label_fftspectrumbinwidth.setObjectName("label_fftspectrumbinwidth")
        self.horizontalLayout_fftspectrum.addWidget(self.label_fftspectrumbinwidth)
        self.fftspectrumbinwidth = QtWidgets.QLineEdit(self.fftspectrumtab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fftspectrumbinwidth.sizePolicy().hasHeightForWidth())
        self.fftspectrumbinwidth.setSizePolicy(sizePolicy)
        self.fftspectrumbinwidth.setAlignment(QtCore.Qt.AlignCenter)
        self.fftspectrumbinwidth.setObjectName("fftspectrumbinwidth")
        self.horizontalLayout_fftspectrum.addWidget(self.fftspectrumbinwidth)
        self.label_fftspectrumhelp = QtWidgets.QLabel(self.fftspectrumtab)
        self.label_fftspectrumhelp.setObjectName("label_fftspectrumhelp")
        self.horizontalLayout_fftspectrum.addWidget(self.label_fftspectrumhelp)
        self.checkBoxFftSpectrumDifference = QtWidgets.QCheckBox(self.fftspectrumtab)
        self.checkBoxFftSpectrumDifference.setObjectName("checkBoxFftSpectrumDifference")
        self.horizontalLayout_fftspectrum.addWidget(self.checkBoxFftSpectrumDifference)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_fftspectrum.addItem(spacerItem1)
        self.gridLayout_fftspectrum.addLayout(self.horizontalLayout_fftspectrum, 1, 0, 1, 1)
        self.tabWidget_2.addTab(self.fftspectrumtab, "")
        ...
        self.actionSet_Reference_Region = QtWidgets.QAction(PythIon)
        self.actionSet_Reference_Region.setObjectName("actionSet_Reference_Region")
        ...
        self.menuEdit.addAction(self.actionSet_Reference_Region)
    ...
    def retranslateUi(self, PythIon):
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.ffttab), _translate("PythIon", "FFT"))
        self.label_fftspectrumbinwidth.setText(_translate("PythIon", "Bin width (kHz):"))
        self.fftspectrumbinwidth.setText(_translate("PythIon", "20"))
        self.checkBoxFftSpectrumDifference.setText(_translate("PythIon", "Show reference difference"))
        self.label_fftspectrumhelp.setText(_translate("PythIon", "Press Enter to update spectrum"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.fftspectrumtab), _translate("PythIon", "FFT Spectrum"))
        ...
        self.actionSet_Reference_Region.setText(_translate("PythIon", "Set Reference Region"))
